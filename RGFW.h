...
void RGFW_monitorCallback(RGFW_window* win, const RGFW_monitor* monitor, RGFW_bool connected) {
	...
	RGFW_event event;
	event.type = (connected) ? (RGFW_eventType)(RGFW_monitorConnected) : (RGFW_monitorDisconnected);
...
RGFW_bool RGFW_createSurfacePtr(u8* data, i32 w, i32 h, RGFW_format format, RGFW_surface* surface) {
	...
	surface->native.format = (format >= RGFW_formatRGBA8) ? (RGFW_format) RGFW_formatBGRA8 : RGFW_formatBGR8;
